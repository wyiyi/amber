...
![](https://wyiyi.github.io/amber/contents/2025/CTE-WITH.jpg)
...
这样看来：
- **不用 WITH：** 逻辑绕，子查询和主查询关联紧密，不好读。像做菜时，每次用调料都要现配，手忙脚乱。
- **用 WITH：** 像提前把所有调料配好放在碗里（SubjectAvg），用的时候直接拿，思路清晰，一目了然。
